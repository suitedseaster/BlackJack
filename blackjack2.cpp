...
class BlackJackGame{
    public:
        ...
        void play(){
            ...
            cout<<"player and casino get hand cleared"<<endl;
            //deal to player 2 cards
            m_deck.deal(*(m_casino->getHand()));
            m_deck.deal(*(m_player->getHand()));
            cout<<"player get 2 cards"<<endl;
            //deal a card to casino
            m_deck.deal(*(m_player->getHand()));
            cout<<"casino get 1 card"<<endl;
        ...
        cout<<"game is done playing"<<endl;
        }
    private:
        Deck m_deck;
